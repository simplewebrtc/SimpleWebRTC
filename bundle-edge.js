...
},{"filetransfer":15,"rtcpeerconnection":14,"util":8,"webrtcsupport":4,"wildemitter":5}],10:[function(require,module,exports){
var util = require('util');
...
},{"getscreenmedia":18,"getusermedia":17,"hark":16,"mediastream-gain":19,"mockconsole":7,"util":8,"webrtcsupport":4,"wildemitter":5}],20:[function(require,module,exports){
/*
      ...
      if (description.type === 'offer') {
        ...
        sections.forEach(function(section, sdpMLineIndex) {
          ...
          var remoteIceParameters = self._getIceParameters(section,
              sessionpart);
          console.log('remote ice parameters', remoteIceParameters);
    ...
    window.RTCPeerConnection.prototype.addIceCandidate = function(candidate) {
      ...
      if (track) {
        ...
        if (cand.protocol.toLowerCase() === 'tcp' && cand.port === 0) {
            if (window.self === window.top && localStorage.debugtcpissue !== 'debug') {
                return;
            } else {
...
PeerConnection.prototype.processIce = function (update, cb) {
    ...
    if (update.contents || (update.jingle && update.jingle.contents)) {
        ...
        self.pc.addIceCandidate(
            ...
            function () {
                console.log('added', update.candidate);
            },
            function (err) {
                self.emit('error', err);
                console.log('err', update.candidate);
            }
        );
...
},{"lodash.foreach":23,"lodash.pluck":24,"sdp-jingle-json":21,"traceablepeerconnection":22,"util":8,"webrtc-adapter-test":20,"wildemitter":5}],15:[function(require,module,exports){
var WildEmitter = require('wildemitter');
var util = require('util');
...
},{"util":8,"wildemitter":5}],16:[function(require,module,exports){
var WildEmitter = require('wildemitter');
...
},{"wildemitter":25}],17:[function(require,module,exports){
...
},{"webrtc-adapter-test":26}],21:[function(require,module,exports){
...
},{"./lib/tojson":27,"./lib/tosdp":28}],26:[function(require,module,exports){
/*
 *  Copyright (c) 2014 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
},{"getusermedia":17}],19:[function(require,module,exports){
...
},{"lodash._arrayeach":32,"lodash._baseeach":30,"lodash._bindcallback":29,"lodash.isarray":31}],24:[function(require,module,exports){
/**
...
},{"./parsers":38,"./senders":37}],28:[function(require,module,exports){
var SENDERS = require('./senders');
...
},{"./senders":37}],29:[function(require,module,exports){
/**
...
},{"util":8,"webrtc-adapter-test":20,"wildemitter":5}],30:[function(require,module,exports){
/**
 * lodash 3.0.4 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._getnative":43,"lodash.isarguments":44,"lodash.isarray":31}],41:[function(require,module,exports){
/**
